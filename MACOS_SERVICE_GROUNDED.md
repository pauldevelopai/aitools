# Grounded macOS Background Service
...
```
~/Library/LaunchAgents/com.grounded.app.plist
```
...
1. Check logs for errors:
   ```bash
   tail -50 "/Users/paulmcnally/Developai Dropbox/Paul McNally/DROPBOX/ONMAC/PYTHON 2025/aitools/logs/grounded.error.log"
   ```
...
3. Test database connection:
   ```bash
   PGPASSWORD=changeme psql -h localhost -U grounded -d grounded -c "SELECT 1;"
   ```
...
rm ~/Library/LaunchAgents/com.grounded.app.plist
```
