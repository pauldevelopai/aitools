...
Based on your requirements, we attempted to create a customized AI implementation strategy. However, AI Toolkit database does not currently contain sufficient content to provide grounded recommendations.
...
This system only recommends tools and practices explicitly documented in the ingested AI Toolkit content. This ensures all advice is traceable and verified.
"""
...
This plan is grounded in the following AI Toolkit content:
...
"""
    ...
    md += f"\n*Generated by AI Toolkit on {plan.created_at.strftime('%Y-%m-%d %H:%M UTC')}*\n"
