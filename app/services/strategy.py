...
Based on your requirements, we attempted to create a customized AI implementation strategy. However, Grounded database does not currently contain sufficient content to provide grounded recommendations.
...
This system only recommends tools and practices explicitly documented in the ingested Grounded content. This ensures all advice is traceable and verified.
"""
...
This plan is grounded in the following Grounded content:
...
"""
    ...
    md += f"\n*Generated by Grounded on {plan.created_at.strftime('%Y-%m-%d %H:%M UTC')}*\n"
